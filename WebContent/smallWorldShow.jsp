...
<jsp:useBean id="smallWorld" type="bean.GenerateNetwork" scope="request"></jsp:useBean>
</head>
<style type="text/css">
.node {
	stroke: #fff;
		...
		<div id="put" class="pos1">
			<form id="from1" action="smallWorldShow" method="post">
				<table id="table1" border="0">
					<tr>
						...
						<td><input type="text" name="nodeNumber"
							value='<jsp:getProperty property="nodeNumber" name="smallWorld"></jsp:getProperty>'></td>
					</tr>
					<tr>
						<td>average degree:</td>
						<td><input type="text" name="averageDegree"
							value='<jsp:getProperty property="averageDegree" name="smallWorld"></jsp:getProperty>'></td>
					</tr>
					<tr>
						<td>probability:</td>
						<td><input type="text" name="probability"
							value='<jsp:getProperty property="probability" name="smallWorld"></jsp:getProperty>'></td>
					</tr>
					<tr>
						<td>json file name:</td>
						<td><input id="fileId" type="text" name="fileName"
							value='<jsp:getProperty property="fileName" name="smallWorld"></jsp:getProperty>'></td>
					</tr>
				</table>
				<p align="center">
				...
				<table id="table2" border="0">
					<tr>
						<td>average degree:</td>
						<td><jsp:getProperty property="newAverageDegree"
								name="smallWorld"></jsp:getProperty></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><jsp:getProperty property="averagePath" name="smallWorld"></jsp:getProperty></td>
					</tr>
				</table>
			</form>
			<hr>
