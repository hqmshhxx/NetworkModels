...
<jsp:useBean id="randomGraph" type="bean.GenerateNetwork" scope="request"></jsp:useBean>
</head>
<style type="text/css">
.node {
	stroke: #E8DECD;
				...
				<table id="table1" border="0">
					<tr>
						...
						<td><input type="text" name="nodeNumber"
							value='<jsp:getProperty property="nodeNumber" name="randomGraph"></jsp:getProperty>'></td>
					</tr>
					
					<tr>
						<td>probability:</td>
						<td><input type="text" name="probability"
							value='<jsp:getProperty property="probability" name="randomGraph"></jsp:getProperty>'></td>
					</tr>
					<tr>
						<td>json file name:</td>
						<td><input id="fileId" type="text" name="fileName"
							value='<jsp:getProperty property="fileName" name="randomGraph"></jsp:getProperty>'></td>
					</tr>
				</table><p>
				<p align="center">
				...
				<table id="table2" border="0">
					<tr>
						...
						<td><jsp:getProperty property="newAverageDegree"
								name="randomGraph"></jsp:getProperty></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><jsp:getProperty property="averagePath" name="randomGraph"></jsp:getProperty></td>
					</tr>
				</table>
			</form>
			<hr>
